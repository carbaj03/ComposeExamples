...
fun AppTheme(
    ...
    val colors: AppColorPalette = if (darkTheme) DarkColorPalette else LightColorPalette

    val sysUiController: SystemUiController = SysUiController.current
...
class AppColorPalette(
    ...
    fun update(other: AppColorPalette) {
...
fun ProvideAppColors(
    ...
    Providers(AppColorAmbient provides colorPalette, children = content)
}

private val AppColorAmbient = staticAmbientOf<AppColorPalette> {
