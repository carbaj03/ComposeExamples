...
package com.example.composeexmples.app.components
...
import com.example.composeexmples.app.home.model.Filter
...
fun FilterChip(
    ...
    val backgroundColor =
        animate(if (selected) AppTheme.colors.brand else AppTheme.colors.uiBackground)
